...
await page.screenshot({ path: "screenshots/feat-stats.png", fullPage: true });
console.log("✓ stats");
...
await page.screenshot({ path: "screenshots/feat-pick.png" });
console.log("✓ pick (期望友好错误态)");
// 3. 清单详情（一起选入口按钮）
await page.goto(`${BASE}${listHref}`);
await page.waitForTimeout(1000);
await page.screenshot({ path: "screenshots/feat-listentry.png" });
console.log("✓ list entry");
// 4. 主页（quick-add 新按钮 + 建单类别 chips）
await page.goto(`${BASE}/lists`);
await page.waitForTimeout(900);
await page.screenshot({ path: "screenshots/feat-home.png", fullPage: true });
console.log("✓ home");
await browser.close();
